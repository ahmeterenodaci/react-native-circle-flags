...
import TrFlag, {
  TrFlagSource,
} from 'react-native-circle-flags/country/tr-flag';

import {
  CircleCountryFlag,
  CircleLanguageFlag,
  CircleOtherFlag,
} from 'react-native-circle-flags';
...
export default function App() {
  return (
    <View style={styles.container}>
      <Image source={TrFlagSource} style={styles.flag} />
      <TrFlag size={64} style={{ marginTop: 20 }} />
      <CircleCountryFlag code="us" size={64} style={{ marginTop: 20 }} />
      <CircleLanguageFlag code="en-au" size={64} style={{ marginTop: 20 }} />
      <CircleOtherFlag code="pirate" size={64} style={{ marginTop: 20 }} />
    </View>
    // <View style={styles.container}>
